...
LABEL_OPTION_GROUPS: list[dict[str, Any]] = [
    ...
    },
    {
        ...
        "dimensions": [
            ...
            {"name": "食品分类", "opions": ["中餐", "烧烤烤肉", "西餐", "下午茶", "日式料理", "水果", "冷饮类", "热饮类", "蔬菜类", "野餐露营"]},
            {"name": "场景色温", "opions": ["暖调", "中性调", "冷调"]},
            {"name": "场景影调", "opions": ["室内暗调", "室外暗调", "室内凉调", "室外亮调"]},
            {"name": "餐品数量", "opions": ["1", "2", "3", "4", "5", "6", "6+"]},
            {"name": "拍摄视角", "opions": ["高", "中", "低"]},
        ],
    },
]
